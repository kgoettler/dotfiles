...
c.ConsoleWidget.font_family = 'Fira Mono Regular'

## The font size. If unconfigured, Qt will be entrusted with the size of the
#  font.
c.ConsoleWidget.font_size = 9
...
#c.JupyterWidget.syntax_style = 'sialoquent'

color_theme = 'sialoquent'  # specify color theme
