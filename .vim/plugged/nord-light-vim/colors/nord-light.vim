...
let s:nord_vim_version="0.1"
set background=dark

let s:nord0_gui = "#D8DEE9"
let s:nord1_gui = "#E5E9F0"
let s:nord2_gui = "#F0F4FC"
let s:nord3_gui = "#A1ACC0"
let s:nord3_gui_bright = "#A1ACC0"
let s:nord4_gui = "#60728C"
let s:nord5_gui = "#485163"
let s:nord6_gui = "#ECEFF4" " light white
let s:nord7_gui = "#29838D" " dark cyan
let s:nord8_gui = "#398EAC" " cyan
let s:nord9_gui = "#3B6EA8" " blue
let s:nord10_gui = "#2C7088" " dark blue
let s:nord11_gui = "#99324B" " red
let s:nord12_gui = "#AC4426" " orange
let s:nord13_gui = "#9A7500" " yellow
let s:nord14_gui = "#4F894C" " green
let s:nord15_gui = "#842879" " purple
