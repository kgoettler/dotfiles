...
" Declare theme name
let g:colors_name = "sialoquent-light"

" Define reusable colors
let s:black            = { "gui": "#D8DEE9", "cterm": "16"  }
let s:white            = { "gui": "#2E3440", "cterm": "231" }
let s:error            = { "gui": "#99324B", "cterm": "231" }
let s:almostWhite      = { "gui": "#393F4C", "cterm": "255" }
...
let s:middleLightPink  = { "gui": "#99324B", "cterm": "167" }
let s:lightPink        = { "gui": "#FFAFAF", "cterm": "217" }

let s:darkBlue         = { "gui": "#29838D", "cterm": "24"  }
let s:middleDarkBlue   = { "gui": "#3B6EA8", "cterm": "24"  }
let s:middleLightBlue  = { "gui": "#5272AF", "cterm": "116" }
let s:lightBlue        = { "gui": "#398EAC", "cterm": "195" }
...
" Custom
let s:almostBlack      = { "gui": "#B8C5DB", "cterm": "233" }
let s:middleYellow     = { "gui": "#9A7500", "cterm": "149" }
let s:lightGreen       = { "gui": "#4F894C", "cterm": "157" }
...
if version >= 700
  ...
  call s:h("CursorLineNr", {"fg": s:middleYellow})
